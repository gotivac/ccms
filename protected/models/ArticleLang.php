 ...
 *
 * The followings are the available columns in table 'article_lang':
 * @property integer $id
...
class ArticleLang extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('article_id, created_user_id, updated_user_id', 'numerical', 'integerOnly'=>true),
			array('lang, title, slug, keywords, description', 'length', 'max'=>255),
			array('content, created_dt, updated_dt', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, article_id, lang, title, slug, content, keywords, description, created_user_id, created_dt, updated_user_id, updated_dt', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return ArticleLang the static model class
	 */
