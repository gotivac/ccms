 ...
 * @property ArticleInGroup[] $articleInGroups
 */
class ArticleGroup extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, title, slug, created_user_id, created_dt, updated_user_id, updated_dt', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'articleInGroups' => array(self::HAS_MANY, 'ArticleInGroup', 'article_group_id'),
