 ...
 * @property ArticleGallery[] $articleGalleries
 * @property ArticleLang[] $articleLangs
 */
class Article extends MultilingualActiveRecord
{
	...
	public function rules()
	{
		...
		$rules =  array(
			...
			array('article_category_id, created_user_id, updated_user_id,active', 'numerical', 'integerOnly'=>true),
			array('title, slug, keywords, description', 'length', 'max'=>255),
			array('content, teaser, created_dt, updated_dt', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, article_category_id, title, slug, content, teaser, keywords, description, active, created_user_id, created_dt, updated_user_id, updated_dt', 'safe', 'on'=>'search'),
		);
	...
	public function relations()
	{
		...
		return array(
			...
			'articleGallery' => array(self::HAS_MANY, 'ArticleGallery', 'article_id'),
			'articleLangs' => array(self::HAS_MANY, 'ArticleLang', 'article_id'),
	...
	public function attributeLabels()
	{
        ...
        foreach ($this->languages() as $l) {
            ...
            $labels['content_'.$l] = Yii::t('app','Content');
            $labels['slug_'.$l] = Yii::t('app','Slug');
            $labels['keywords_'.$l] = Yii::t('app','Keywords');
            $labels['description_'.$l] = Yii::t('app','Description');
			$labels['teaser_'.$l] = Yii::t('app','Teaser');
    ...
    {
        return ArticleGallery::model()->find(array('condition'=>'article_id='.$this->id,'order'=>'priority ASC'));
    }
}
