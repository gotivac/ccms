...
class MenuLang extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('menu_id, created_user_id, updated_user_id', 'numerical', 'integerOnly'=>true),
			array('lang, title, link', 'length', 'max'=>255),
			array('created_dt, updated_dt', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, menu_id, lang, title, link, created_user_id, created_dt, updated_user_id, updated_dt', 'safe', 'on'=>'search'),
		);
	}
