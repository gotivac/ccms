 ...
 */
class GalleryLang extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('gallery_id, created_user_id, updated_user_id', 'numerical', 'integerOnly'=>true),
			array('lang, title, slug', 'length', 'max'=>255),
			array('description, created_dt, updated_dt', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, gallery_id, lang, title, slug, description, created_user_id, created_dt, updated_user_id, updated_dt', 'safe', 'on'=>'search'),
		);
	}
